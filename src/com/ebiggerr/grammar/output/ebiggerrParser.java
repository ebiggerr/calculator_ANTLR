...
public class ebiggerrParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "ebiggerr.g4"; }
	...
	public ebiggerrParser(TokenStream input) {
		super(input);
	...
	public static class ProgContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ebiggerrListener ) ((ebiggerrListener)listener).enterProg(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ebiggerrListener ) ((ebiggerrListener)listener).exitProg(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ebiggerrVisitor ) return ((ebiggerrVisitor<? extends T>)visitor).visitProg(this);
	...
	public static class StatContext extends ParserRuleContext {
		...
		public TerminalNode NEWLINE() { return getToken(ebiggerrParser.NEWLINE, 0); }
		public TerminalNode ID() { return getToken(ebiggerrParser.ID, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ebiggerrListener ) ((ebiggerrListener)listener).enterStat(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ebiggerrListener ) ((ebiggerrListener)listener).exitStat(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ebiggerrVisitor ) return ((ebiggerrVisitor<? extends T>)visitor).visitStat(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class ExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ebiggerrListener ) ((ebiggerrListener)listener).enterExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ebiggerrListener ) ((ebiggerrListener)listener).exitExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ebiggerrVisitor ) return ((ebiggerrVisitor<? extends T>)visitor).visitExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class MultExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ebiggerrListener ) ((ebiggerrListener)listener).enterMultExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ebiggerrListener ) ((ebiggerrListener)listener).exitMultExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ebiggerrVisitor ) return ((ebiggerrVisitor<? extends T>)visitor).visitMultExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class AtomContext extends ParserRuleContext {
		...
		public TerminalNode INT() { return getToken(ebiggerrParser.INT, 0); }
		public TerminalNode ID() { return getToken(ebiggerrParser.ID, 0); }
		public ExprContext expr() {
			return getRuleContext(ExprContext.class,0);
		}
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof ebiggerrListener ) ((ebiggerrListener)listener).enterAtom(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof ebiggerrListener ) ((ebiggerrListener)listener).exitAtom(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof ebiggerrVisitor ) return ((ebiggerrVisitor<? extends T>)visitor).visitAtom(this);
			else return visitor.visitChildren(this);
		}
	}
